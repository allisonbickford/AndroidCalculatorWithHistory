package com.example.androidcalculatorwithhistory.webservice;
...
public class WeatherService extends IntentService {
    ...
    private static final String ACTION_WEATHER_AT = "com.example.androidcalculatorwithhistory.webservice.action.WEATHER_AT";
    private static final String BASE_URL = "https://api.darksky.net/forecast/59e47d411ed495cd49d8bc3815180f6c";
    public static final String BROADCAST_WEATHER = "com.example.androidcalculatorwithhistory.webservice.action.BROADCAST";
    private static final String EXTRA_KEY = "com.example.androidcalculatorwithhistory.webservice.extra.KEY";
    private static final String EXTRA_LAT = "com.example.androidcalculatorwithhistory.webservice.extra.LAT";
    private static final String EXTRA_LNG = "com.example.androidcalculatorwithhistory.webservice.extra.LNG";
